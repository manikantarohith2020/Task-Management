...
defined('BASEPATH') OR exit('No direct script access allowed');
 ...
 <!-- Basic Page Needs
 ================================================== -->
 <title><?=$this->user_model->sitename?> :  Daily Report  </title>
 <meta charset="utf-8">
  ...
  ================================================== -->
    ...
    <div id="titlebar">
      <div class="col-md-10 col-md-offset-1">
          <h2><b> <i class="fa fa-users"></i> Daily Report </b></h2>
          <!-- Breadcrumbs -->
          <nav id="breadcrumbs">
                ...
                <!-- Section -->
                  <div class="add-listing-section">
                      ...
                      <div class="add-listing-headline">
                        <h3><i class="list-box-icon im im-icon-file2"></i> Employees Daily Report
                        </h3>
                      </div>
...
?>
              <tr style="font-size:13px;">
                ...
                <td nowrap><?=$this->user_model->getValue('full_name', 'employees', 'emp_id', $row->emp_id)?></td>                                
                <td nowrap style="width: 40%;"><?=$row->description?></td>
                <td><?=date('d-M-Y',strtotime($row->create_date))?></td>
                <td nowrap>
                 <a href="<?=base_url()?>admin/del_daily_report/<?=md5($row->id)?>" class="small Reject" style="font-size:12px; padding:2px 10px;" onclick="if(confirm('Are You Sure To Delete?')) { return true;} else { return false;}"> <i class="fa fa-trash-o" ></i>  </a> 
                </td>
              </tr>
<?php
  }
