...
defined('BASEPATH') OR exit('No direct script access allowed');
 ...
 <!-- Basic Page Needs
 ================================================== -->
 <title><?=$this->user_model->sitename?> :  Tasks  </title>
 <meta charset="utf-8">
  ...
  ================================================== -->
    ...
    <div id="titlebar">
      <div class="col-md-10 col-md-offset-1">
          <h2><b> <i class="fa fa-list"></i> Tasks </b></h2>
          <!-- Breadcrumbs -->
          <nav id="breadcrumbs">
...
<div class="col-md-4 col-md-offset-4">
                      <div class="row with-forms box3d2" style="font-size: 14px; padding-bottom: 0;">
                        ...
                        <div class="col-md-6">
                              <select name=""  onchange="window.location.href='<?=base_url()?>admin/tasks/'+this.value;" >
                  ...
                  <div class="add-listing-section">
                      ...
                      <div class="add-listing-headline">
                        <h3><i class="list-box-icon im im-icon-User"></i> List of Tasks
                          <a href="<?=base_url()?>admin/new_task" style="float: right;"><button class="button rounded"><small><i class="fa fa-plus"></i>Add New Task</small></button></a>
                        </h3>
                      </div>
...
?>
              <tr style="font-size:13px;">
                <td nowrap><?=$i?></td>
                <td nowrap><b><?=$this->user_model->getValue('full_name', 'employees', 'emp_id', $row->emp_id)?></b></td>                
                <td nowrap><?=$row->title?></td>
                <td nowrap><span class="<?=$row->status?>"><?=$row->status?></span></td>
                <td><?=date('d-M-Y',strtotime($row->create_date))?></td>
                <td nowrap>
                  <a href="<?=base_url().'admin/edit_task/'.md5($row->id)?>" class="Pending small" style="font-size:12px; padding:2px 10px;"><i class="fa fa-edit"></i> Edit </a>
                 <a href="<?=base_url()?>admin/del_task/<?=md5($row->id)?>" class="small Reject" style="font-size:12px; padding:2px 10px;" onclick="if(confirm('Are You Sure To Delete?')) { return true;} else { return false;}"> <i class="fa fa-trash-o" ></i>  </a> 
                </td>
              </tr>
<?php
  }
