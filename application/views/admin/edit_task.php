...
defined('BASEPATH') OR exit('No direct script access allowed');
 ...
 <!-- Basic Page Needs
 ================================================== -->
 <title><?=$this->user_model->sitename?> :  Edit Task </title>
 <meta charset="utf-8">
  ...
  ================================================== -->
    ...
    <div id="titlebar">
      <div class="col-md-10 col-md-offset-1">
          <h2><b> <i class="fa fa-edit"></i> Edit Task </b></h2>
          <!-- Breadcrumbs -->
          <nav id="breadcrumbs">
    ...
    <?=$this->session->flashdata('messagePr')?>
                    ...
                    <div class="add-listing-section">
                      ...
                      <div class="add-listing-headline">
                        <h3><i class="list-box-icon im im-icon-User"></i> Task Details</h3>
                      </div>

                      <!-- Row -->
                              <form method="post" action="<?=base_url()?>admin/edit_task_sub/<?=md5($res->id)?>" enctype="multipart/form-data">
                      <div class="row with-forms">
                        <div class="col-md-6">
                              <h5><i class="fa fa-user"></i> <b> Employee: *</b></h5>
                        </div>
                        <div class="col-md-6">
                              <select name="emp_id" required >
                                ...
                                <?php
                                foreach ($emp as $r) { ?>
                                  <option value="<?=$r->emp_id?>" <?php if($r->emp_id == $res->emp_id) echo 'selected'; ?> ><?=$r->full_name?></option>;
                                <?php } ?>
                              </select>
                        </div>
                      </div>
                      ...
                      <div class="row with-forms">
                        <div class="col-md-12">
                              <h5><i class="fa fa-user"></i> <b> Task Title: *</b></h5>
                              <input type="Text" name="title" required value="<?=$res->title?>" />
                        </div>
                     </div>
                      ...
                      <div class="row with-forms">
                        <div class="col-md-12">
                              ...
                              <textarea name="description" required rows="9"><?=$res->description?></textarea>
                        </div>
                      </div>
                      ...
                      <div class="row with-forms">
                        <div class="col-md-12">
                              ...
                              <textarea name="emp_remarks" required rows="4"><?=$res->emp_remarks?></textarea>
                                            ...
                                            <div class="row with-forms">
                        <div class="col-md-12">
                              <h5><i class="fa fa-user"></i> <b> Admin Remarks: *</b></h5>
                              <textarea name="admin_remarks" required rows="4"><?=$res->admin_remarks?></textarea>
                        </div>
                      </div>

                      <div class="row with-forms">
                        <div class="col-md-6">
                              <h5><i class="fa fa-user"></i> <b> Status: *</b></h5>
                        </div>
                        <div class="col-md-6">
