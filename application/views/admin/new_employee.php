...
defined('BASEPATH') OR exit('No direct script access allowed');
 ...
 <!-- Basic Page Needs
 ================================================== -->
 <title><?=$this->user_model->sitename?> :  New Employee </title>
 <meta charset="utf-8">
  ...
  ================================================== -->
    ...
    <div id="titlebar">
      <div class="col-md-10 col-md-offset-1">
          <h2><b> <i class="fa fa-edit"></i> New Employee </b></h2>
          <!-- Breadcrumbs -->
          <nav id="breadcrumbs">
...
<br/>
    <?=$this->session->flashdata('messagePr')?>
                    ...
                    <div class="add-listing-section">
                      ...
                      <!-- Row -->
                              <form method="post" action="<?=base_url()?>admin/new_employee_sub" enctype="multipart/form-data">
                      ...
                      <div class="row with-forms">
                        <div class="col-md-12">
                          ...
                          <div class="row with-forms">                                
                                  <div class="col-md-12">
                                    <h5><b>Mobile No:  *</b></h5>
                                    <input type="number" name="phno" required  value=""/>
                                  </div>
                            </div>
                          <div class="row with-forms">
                                  <div class="col-md-12">
                                 ...
                                 <div class="row with-forms">                                      
                                        <div class="col-md-12">
                                          <h5><b>Password:  *</b></h5>
                                          <input type="text" name="password" required  value="12345"/>
                                        </div>
                                        </div>
                                <div class="row with-forms">
                                        <div class="col-md-12">
