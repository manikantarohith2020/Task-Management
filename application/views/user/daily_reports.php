...
defined('BASEPATH') OR exit('No direct script access allowed');
 ...
 <!-- Basic Page Needs
 ================================================== -->
 <title><?=$this->user_model->sitename?> : My Daily Reports  </title>
 <meta charset="utf-8">
  ...
  ================================================== -->
    ...
    <div id="titlebar">
      <div class="col-md-10 col-md-offset-1">
          <h2><b> <i class="fa fa-users"></i> My Daily Reports </b></h2>
          <!-- Breadcrumbs -->
          <nav id="breadcrumbs">
                ...
                <!-- Section -->
                  <div class="add-listing-section">
                      ...
                      <div class="add-listing-headline">
                        <h3><i class="list-box-icon im im-icon-file2"></i> Daily Reports
                          <a href="<?=base_url()?>user/post_daily_report" style="float: right;"><button class="button rounded"><small><i class="fa fa-plus"></i>Post Daily Report</small></button></a>
                        </h3>
                      </div>
...
?>
              <tr style="font-size:13px;">
                <td nowrap><?=$i?></td>
                <td nowrap><b><?=date('D d-M-Y',strtotime($row->report_date))?></b></td>
                <td nowrap style="width: 40%;"><?=$row->description?></td>
                <td><?=date('d-M-Y',strtotime($row->create_date))?></td>
                <td nowrap>
                 <a href="<?=base_url()?>user/del_daily_report/<?=md5($row->id)?>" class="small Reject" style="font-size:12px; padding:2px 10px;" onclick="if(confirm('Are You Sure To Delete?')) { return true;} else { return false;}"> <i class="fa fa-trash-o" ></i>  </a> 
                </td>
              </tr>
<?php
  }
